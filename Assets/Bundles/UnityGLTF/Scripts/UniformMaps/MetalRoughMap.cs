...
namespace UnityGLTF {
  class MetalRoughMap : MetalRough2StandardMap {
    ...
    public override int BaseColorTexCoord { get { return 0; } set { return; } }

    public override Texture MetallicRoughnessTexture {
      get { return this._material.GetTexture("_MetallicGlossMap"); }
      set {
        this._material.SetTexture("_MetallicGlossMap", value);
        this._material.EnableKeyword("_METALLICGLOSSMAP");
      }
    }

    public override int MetallicRoughnessTexCoord { get { return 0; } set { return; } }

    public override IUniformMap Clone() {
      var copy = new MetalRoughMap(new Material(this._material));
      base.Copy(copy);
      return copy;
    }
  }
