  ...
  public class GLTFImporterInspector : AssetImporterEditor {
    ...
    public override void OnInspectorGUI() {
      if (_importNormalsNames == null) {
        _importNormalsNames = Enum.GetNames(typeof(GLTFImporterNormals)).Select(n => ObjectNames.NicifyVariableName(n))
            .ToArray();
      }
      ...
      EditorGUILayout.PropertyField(
          serializedObject.FindProperty("_readWriteEnabled"),
      ...
      var importNormals = EditorGUILayout.Popup(
          importNormalsProp.displayName,
          importNormalsProp.intValue,
          _importNormalsNames);
      ...
      EditorGUILayout.PropertyField(
          serializedObject.FindProperty("_useJpgTextures"),
          new GUIContent("Use JPG Textures"));
