...
namespace UnityEditor {
  internal class PbrShaderGUI : ShaderGUI {
    ...
    private static class Styles {
      ...
      public static GUIContent emissiveWarning = new GUIContent(
    ...
    void DoSpecularMetallicArea() {
      ...
      if (m_WorkflowMode == WorkflowMode.SpecularGlossiness) {
        ...
        m_MaterialEditor.ShaderProperty(
            smoothness,
            hasGlossMap ? Styles.glossinessScaleText : Styles.glossinessText,
            2);
    ...
    static void SetMaterialKeywords(Material material, WorkflowMode workflowMode) {
      ...
      var shouldEmissionBeEnabled = material.GetColor("_EmissionColor") != Color.black;
